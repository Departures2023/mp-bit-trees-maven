...
public class BrailleAsciiTables {
  ...
  // +-----------------------+/
  /**
   * Helper function for toBraille.
   * @param bits input ascii string
   * @return Braille string
   */
  public static String toBrailleHelper(String bits) {
  ...
  public static String toBraille(char letter) {
    return toBrailleHelper(asciiToBinary(Character.toString(letter)));
  } // toBraille(char)
